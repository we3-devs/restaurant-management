...
@Module({
  imports: [AuthModule, WarehousesModule, DiningTablesModule, TypeOrmModule.forFeature([Food, FoodCategory, FoodVariant, FoodRecipe, WarehouseIngredientStock, Variant, SubVariant, AddonGroup, Addon, FoodAddonGroup])],
