          ...
          <div className="flex justify-end" onClick={(event) => event.stopPropagation()}>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => router.push(`/dashboard/organization/customers/${row.original.id}`)}>
                  View details
                </DropdownMenuItem>
            ...
            <TableBody>
              {table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() => router.push(`/dashboard/organization/customers/${row.original.id}`)}
                >
