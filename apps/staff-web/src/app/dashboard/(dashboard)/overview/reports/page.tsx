...
/** Index for the reports section — every report is its own page under /dashboard/overview/reports/<slug>. */
            ...
            <section key={group.group} className="space-y-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {group.reports.map((report) => (
                  <Link
                    key={report.slug}
                    href={`/dashboard/overview/reports/${report.slug}`}
                    className="group flex flex-col gap-1.5 rounded-lg border border-border p-4 transition-colors hover:bg-accent/40"
                  >
