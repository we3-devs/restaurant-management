...
import { useImportJobs } from "@/hooks/use-data-import"
    ...
    <Table>
      ...
      <TableBody>
        {jobs.map((job) => {
          ...
          const statusLabel = STATUS_LABEL[statusKey] ?? STATUS_LABEL.unknown
          const statusVariant = STATUS_VARIANT[statusKey] ?? STATUS_VARIANT.unknown
