...
/** Read-only mirror of the operational floor board — monitoring only, no table actions live here. */
export default function ViewTablesPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {outletId ? <FloorOverview outletId={outletId} /> : <p className="text-sm text-muted-foreground">Select an outlet.</p>}
    </div>
  )
}
