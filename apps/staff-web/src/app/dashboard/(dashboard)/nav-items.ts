...
export const navGroupDefs: NavGroupDef[] = [
  {
    ...
    links: [
      ...
      { href: "/dashboard/view-dining", label: "View Dining Areas", permission: "dining-tables.view" },
      { href: "/dashboard/view-table", label: "View Tables", permission: "dining-tables.view" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dashboard/credit", label: "Customer Credit", permission: "customer-credit.view" },
