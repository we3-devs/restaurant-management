...
import { createDiningAreaSchema, type CreateDiningAreaInput } from "@/lib/validators/dining-areas"

/** Superadmin-only dining area provisioning — mirrors operational-web's create dialog. */
export function CreateDiningAreaDialog() {
  ...
  const form = useForm<CreateDiningAreaInput>({
    resolver: zodResolver(createDiningAreaSchema),
    defaultValues: { outletId: 0, name: "", code: "" },
  })
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button>Create dining area</Button>} />
      <DialogContent>
        <DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl placeholder="Main Hall" {...field} />
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl placeholder="MAIN" {...field} />
                  <FormMessage />
                </FormItem>
              )}
            />
            <DialogFooter>
              <Button type="submit" disabled={createDiningArea.isPending}>
                {createDiningArea.isPending ? "Creating..." : "Create dining area"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
