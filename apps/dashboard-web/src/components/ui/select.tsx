  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Long option lists (ingredient/food/supplier pickers can have 100-200
        // items) skip layout/paint while off-screen — content-visibility keeps
        // items in the DOM (unlike unmounting), so native keyboard nav,
        // typeahead, and screen readers still see every option.
