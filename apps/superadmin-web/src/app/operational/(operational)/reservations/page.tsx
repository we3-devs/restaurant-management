...
import { DataTablePagination } from "@rms/ui/data-table-pagination"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { useReservations, useReservationTables, type Reservation } from "@rms/api-client/hooks/use-reservations"
import { useReservationsBootstrap } from "@rms/api-client/hooks/use-bootstrap"
import { useActiveOutlet } from "@rms/api-client/outlet/active-outlet-context"
import { RESERVATION_STATUSES } from "@rms/validators/reservations"
          ...
          <div className="flex justify-end" onClick={(event) => event.stopPropagation()}>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => router.push(`/operational/reservations/${row.original.id}`)}>
                  View details
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <TableBody>
              {table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() => router.push(`/operational/reservations/${row.original.id}`)}
                >
